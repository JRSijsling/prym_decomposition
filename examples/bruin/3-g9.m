...
comptyps := [ typ2 : i in [1..12] ] cat [ typ3 ];
mergtyps := [ typ1 : i in [1..12] ] cat [ typ0 ];
comptyps := [ typ2 : i in [1..10] ] cat [ typ3 : j in [1..2] ];
mergtyps := [ typ1 : i in [1..10] ] cat [ typ0 : j in [1..2] ];
comptyps := [ typ2 : i in [1..8] ] cat [ typ3 : j in [1..3] ];
mergtyps := [ typ1 : i in [1..8] ] cat [ typ0 : j in [1..3] ];
comptyps := [ typ2 : i in [1..6] ] cat [ typ3 : j in [1..4] ];
mergtyps := [ typ1 : i in [1..6] ] cat [ typ0 : j in [1..4] ];
comptyps := [ typ2 : i in [1..4] ] cat [ typ3 : j in [1..5] ];
mergtyps := [ typ1 : i in [1..4] ] cat [ typ0 : j in [1..5] ];
comptyps := [ typ2 : i in [1..2] ] cat [ typ3 : j in [1..6] ];
mergtyps := [ typ1 : i in [1..2] ] cat [ typ0 : j in [1..6] ];
comptyps := [ typ3 : j in [1..7] ];
mergtyps := [ typ0 : j in [1..7] ];
comptyps := [ typ2 : i in [1..14] ];
mergtyps := [ typ1 : i in [1..14] ];
